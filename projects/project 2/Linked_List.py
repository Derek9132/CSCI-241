class Linked_List:
    ...
    def __len__(self):
        ...
        while cur.next != None:
            ...
            cur = cur.next
        return len
    #The performance of this function is O(n) as the algorithm's completion time increases with the size of the input.
    #Any method that requires getting each element of the linked list or visiting every node will be at least linear time O(n).
    #What is the point of the len() function when the linked list has a self.__size attribute?
    ...
    def rotate_left(self):
        ...
        #This was the method I was dreading the most, as its description made it sound like it was going to be the most complicated method in the program.
        #You could imagine my surprise when I ended up finishing it in 5-10 minutes.
